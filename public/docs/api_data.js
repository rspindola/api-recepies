define({ "api": [
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "portion",
            "description": "<p>Número de porções da receita.</p>"
          },
          {
            "group": "Success 200",
            "type": "Array",
            "optional": false,
            "field": "preparing",
            "description": "<p>Passo a passo do preparo da receita.</p>"
          },
          {
            "group": "Success 200",
            "type": "Array",
          ...
          },
          {
            ...
            "optional": false,
            "field": "note",
            "description": "<p>Anotações de dicas sobre a receita.</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
  ...
  },
  {
    ...
    "title": "Listar Receitas por Categoria",
    "description": "<p>Obtém a listagrem de todas as receitas de determinada categoria</p>",
    "name": "ListarReceitasByCategory",
    "group": "Receita",
    "version": "0.0.1",
    "filename": "routes/api/recipes.php",
    "groupTitle": "Receita",
    "sampleRequest": [
      {
        "url": "https://recipes.renatospindolasistemas.com.br/api/recipes/category/:category"
      }
    ],
    "success": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/recipes/slug/:slug",
    "title": "Obter Receita (Slug)",
    "description": "<p>Obtém a receita no sistema pelo slug</p>",
    "name": "ObterReceita",
    "group": "Receita",
    "version": "0.0.1",
    "parameter": {
    ...
    "sampleRequest": [
      {
        "url": "https://recipes.renatospindolasistemas.com.br/api/recipes/slug/:slug"
      }
    ],
    "success": {
      "fields": {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://recipes.renatospindolasistemas.com.br/api/recipes/id/:id"
      }
    ],
    "success": {
      "fields": {
